...
#include <stdlib.h>
#include <ctime>
#include <iomanip> //tabla
#include <cctype> //validacion caracteres
...
void leer_equipos(equipos x[]){
    ...
    for(int i=0;i<8;i++){
        ...
        if (checkletra(x[i].nombre)==false){
            HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
            SetConsoleTextAttribute(hConsole, 4);
            cout<<"Nombre de equipo invalido, el nombre del equipo solo puede contener letras"<<endl;
            i--;
            contador--;
        }
        for (int j = 0; j < contador; j++)
        {
            ...
            HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
            SetConsoleTextAttribute(hConsole, 4);
                cout<<"El equipo ingresado ya existe."<<endl;
                i--;
                contador--;
            }
        }
...
void simulacion_manual(equipos x[],int infpar[8][3]){
        ...
        for(int i=1;i<8;i++){  
            ...
            if ((goles_equipo1-goles_equipo2)>6){
                superganadores<<"El equipo: "<<x[0].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[0].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[0].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[0].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        for(int i=2;i<8;i++){
            ...
            if ((goles_equipo1-goles_equipo2)>6){
                superganadores<<"El equipo: "<<x[1].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[1].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[1].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[1].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        for(int i=3;i<8;i++){
            ...
            if ((goles_equipo1-goles_equipo2)>6){
                superganadores<<"El equipo: "<<x[2].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[2].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[2].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[2].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        for(int i=4;i<8;i++){
            ...
            if ((goles_equipo1-goles_equipo2)>56){
                superganadores<<"El equipo: "<<x[3].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[3].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[3].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[3].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        for(int i=6;i<8;i++){
            ...
            if ((goles_equipo1-goles_equipo2)>6){
                superganadores<<"El equipo: "<<x[5].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[5].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[5].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[5].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        for(int i=7;i<8;i++){
            ...
            if ((goles_equipo1-goles_equipo2)>6){
                superganadores<<"El equipo: "<<x[6].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[6].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[6].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[6].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        if (band==0)
        {
            empatados<<"Ninguno equipo empato algun partido"<<endl;
        }
        
        empatados.close();
        superganadores.close();
        superperdedores.close();
...
void simulacion_automatica(equipos x[],int infpar[8][3]){
        ...
        for(int i=5;i<8;i++){
            ...
            if ((goles_equipo1-goles_equipo2)>6){
                superganadores<<"El equipo: "<<x[4].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[i].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
                superperdedores<<"El equipo: "<<x[i].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[4].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
            }
            else if ((goles_equipo2-goles_equipo1)>6){
                superganadores<<"El equipo: "<<x[i].nombre<<" le gano por mas de 6 goles de diferencia a: "<<x[0].nombre<<" el partido termino: "<<goles_equipo2<<" - "<<goles_equipo1<<endl;
                superperdedores<<"El equipo: "<<x[4].nombre<<" perdio por mas de 6 goles de diferencia con: "<<x[4].nombre<<" el partido termino: "<<goles_equipo1<<" - "<<goles_equipo2<<endl;
            }
        ...
        if (band==0)
        {
            empatados<<"Ningun equipo empato algun partido"<<endl;
        }
...
void ganadores4 (equipos x[], int infpar [8][3]){
    ...
    ganadoresmas4.open("C:/Users/tauri/OneDrive/Escritorio/Proyecto final Programacion/ganadores4.txt");
    bool band=0;
    for (int i = 0; i < 8; i++)
    {
        if(infpar[i][0]>4){
...
void perdedores4 (equipos x[], int infpar[8][3]){
    ...
    perdedores4.open("C:/Users/tauri/OneDrive/Escritorio/Proyecto final Programacion/perdedores4.txt");
    bool band=0;
    for (int i = 0; i < 8; i++)
    {
        if(infpar[i][1]>4){
...
void tabla(equipos x[], int infpar[8][3], equipos aux){
    ofstream tablapos;
    tablapos.open("C:/Users/tauri/OneDrive/Escritorio/Proyecto final Programacion/Tabla.txt");
    bool bandera=0;
    int aux1, aux2, aux3;
    while (bandera == 0)
    {
